...
class D(nn.Module): # We introduce a class to define the discriminator.
    ...
    def __init__(self): # We introduce the __init__() function that will define the architecture of the discriminator.
        ...
        self.main = nn.Sequential( # We create a meta module of a neural network that will contain a sequence of modules (convolutions, full connections, etc.).
            ...
            """
                Q: What are the parameters passed inside the nn.Conv2d?
                ANS: (in_channels, out_channels, kernel_size, stride,
    ...
    """
        Q: Why we need to take view?
        ANS: view is used to change the format of output. It is just like reshape for torch tensor.
    """
...
for epoch in range(25): # We iterate over 25 epochs.
    ...
    for i, data in enumerate(dataloader, 0): # We iterate over the images of the dataset.
        ...
        input = Variable(real) # We wrap it in a variable(torh variable).
        ...
        """
            Q: Here we are calling forward method by just calling object. How??
            ANS: In python when you call object of class, it means you are actually calling __call__ method.
                __call__ method of pytorch.nn.module, calls _slow_forward method of pytorch.nn.module.
                _slow_forward method calls forward method by taking care of input as well.
        """
        ...
        """
            Here we get total error for disciminator
            Now this total error is used to calculate gradient
            This gradient is finally used by optimizer to take steps towards the local minimum.
        """
        ...
        """
            Here we are using generated fake image by generator while training discriminator.
            But generating again a new fake image is good practise and it is also suggested in GAN papers.
        """
